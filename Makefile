...
#-lGL -lGLU -lglut
LIBS = -lfreenect -framework GLUT -framework OpenGL -lglfw3 -lglew -lopencv_core -lopencv_highgui -lopencv_flann -lopencv_video -lopencv_imgproc -lopencv_calib3d -lopencv_features2d -lopencv_nonfree -lpcl_common -lpcl_io -lpcl_registration -lpcl_kdtree -lpcl_keypoints -lpcl_search -lpcl_features -lpcl_filters -lpcl_sample_consensus -lboost_system
